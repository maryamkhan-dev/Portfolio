...
const contactLinks = [
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/maryamkhan',
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `mailto:maryam.babar.khan.dev@gmail.com?subject=${subject}&body=${body}`,
      '_blank'
    );
    setSubmitted(true);
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            {submitted ? (
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4 bg-sky-50">
                  <svg className="w-8 h-8 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <h3 className="text-slate-800 font-semibold text-lg mb-2">Message sent!</h3>
                <p className="text-slate-500 text-sm">Your mail client should have opened. I'll get back to you soon.</p>
              </motion.div>
            ) : (
